                        ...
                        <div class="form-validation">
                            <form class="form-valide" id="add-post-form" action="?mod=posts&action=addPost" method="post" enctype="multipart/form-data">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="post_title" rules="required|min:6|max:120" class="form-control input-custom" value="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select data-placeholder="Select a Language..." class="form-control select-custom chosen-select" rules="required" name="post_category[]" multiple>
                                            <?php foreach($post_categories as $post_category): ?>
                                                
                                                <option value="<?php echo $post_category['post_category_id']; ?>">
                                                    <?php echo $post_category['post_category_name']; ?> 
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        <span class='error'></span>
